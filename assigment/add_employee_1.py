...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.resizable(1,  1)
        top.title("E-Tracking - Administrator - Add Employee")
        ...
        self.Label_add_employee = tk.Label(self.Frame2)
        self.Label_add_employee.place(relx=0.197, rely=0.033, height=96
                , width=362)
        self.Label_add_employee.configure(activebackground="#f9f9f9")
        self.Label_add_employee.configure(background="#ffffff")
        self.Label_add_employee.configure(compound='left')
        self.Label_add_employee.configure(disabledforeground="#a3a3a3")
        self.Label_add_employee.configure(font="-family {Segoe UI} -size 20 -weight bold")
        self.Label_add_employee.configure(foreground="#000000")
        self.Label_add_employee.configure(highlightbackground="#d9d9d9")
        self.Label_add_employee.configure(highlightcolor="black")
        self.Label_add_employee.configure(text='''Add Employee''')

        self.Label_employ_ID = tk.Label(self.Frame2)
        self.Label_employ_ID.place(relx=0.162, rely=0.612, height=26, width=52)
        self.Label_employ_ID.configure(activebackground="#f9f9f9")
        self.Label_employ_ID.configure(anchor='w')
        self.Label_employ_ID.configure(background="#ffffff")
        self.Label_employ_ID.configure(compound='left')
        self.Label_employ_ID.configure(disabledforeground="#a3a3a3")
        self.Label_employ_ID.configure(foreground="#000000")
        self.Label_employ_ID.configure(highlightbackground="#d9d9d9")
        self.Label_employ_ID.configure(highlightcolor="black")
        self.Label_employ_ID.configure(text='''Employee's ID''')
        ...
        self.Label_phone_number = tk.Label(self.Frame2)
        self.Label_phone_number.place(relx=0.162, rely=0.479, height=26
                , width=122)
        self.Label_phone_number.configure(activebackground="#f9f9f9")
        ...
        self.Label_phone_number.configure(highlightbackground="#d9d9d9")
        self.Label_phone_number.configure(highlightcolor="black")
        self.Label_phone_number.configure(text='''Phone Number''')

        self.Label_station = tk.Label(self.Frame2)
        self.Label_station.place(relx=0.162, rely=0.248, height=26, width=122)
        ...
        self.Label_station.configure(text='''Station''')
        ...
        self.Entry_phone_number = tk.Entry(self.Frame2)
        self.Entry_phone_number.place(relx=0.18, rely=0.545, height=34, relwidth=0.654)
        ...
        self.Entry_phone_number.configure(highlightbackground="#d9d9d9")
        self.Entry_phone_number.configure(highlightcolor="black")
        self.Entry_phone_number.configure(insertbackground="black")
        self.Entry_phone_number .configure(selectbackground="#c4c4c4")
        self.Entry_phone_number.configure(selectforeground="black")
        ...
        self.Entry_station = ttk.Combobox(self.Frame2, values = options_station)
        self.Entry_station.place(relx=0.18, rely=0.298, height=34, relwidth=0.654)
    ...
    def add_btn(self):
        add_Employee = self.Entry_employee_ID.get()
        add_name = self.Entry_name.get()
        add_Phone = self.Entry_phone_number.get()
        add_station = self.Entry_station.get()
        if add_Employee == "" or add_name == "" or add_Phone == "" or add_station == "" or add_station == '--select station--':
            tsmg.showerror('Insert Fail','Please Enter all filed!') #alert pop-up
        else:
            if Admin.create_employee(add_station, add_name, add_Phone, add_Employee, add_Phone, AccoutType.Employee) == True:
                tsmg.showinfo('Create Complate','Create Employee!')
            else:
                tsmg.showerror('Create Fail','Invalid Input!') #alert pop-up
