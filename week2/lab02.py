...
class Book:
    ...
    def __init__(self, author_name, title, subject, dds_number):
        ...
        self.item_list = []
        self.item_list.append([str(self.isbn), self.author_name, self.title, self.subject, str(self.dds_nubmer)])
...
Book_1 = Book([Author_1.name, Author_2.name],"Python for newbie", "Computer", 1234)
Book_2 = Book(Author_2.name,"Python for PRO", "Computer", 9999)
#Book_3 = Book(Author_1.name,"Python for PRO", "Computer", 9999)
...
print(Catalog.delete_book("Tavan"))
